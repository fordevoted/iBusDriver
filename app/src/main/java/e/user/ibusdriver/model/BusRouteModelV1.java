...
public class BusRouteModelV1 implements BusRoutePresenter {
	...
	private final static String TAG= "BusRouteModelV1";
	...
	public BusRouteModelV1(Context context){
	...
	public void updateData(TextView tv_people_waiting,TextView tv_stop_name,TextView tv_people_on_bus,TextView tv_people_service,TextView tv_decision,
		...
		numNow = (int)(Math.random() * MaxNum);
		Log.d(TAG, "numNow test " + numNow);
	...
	public void setFontSizeByMobile(TextView[] textViews, Point size) {
		...
		for(TextView textView :textViews){
			switch (index){
				...
				case 1 :{
					textView.setTextSize((float) (size.y * 0.0125));
					break;
				}
				default:{
